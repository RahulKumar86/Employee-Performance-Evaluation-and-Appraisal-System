...
<?php
	...
	$query = "SELECT * from project LEFT JOIN nam on project.Sid= nam.ID where nam.ID=$xy";
		...
		<?php
			while($data = mysqli_fetch_assoc($run)){
				echo "<tr>
						...
						<td> <a href='update.php?i=$data[id]&n=$data[Name]&m=$data[mob]&e=$data[Mail]&p=$data[Performance]&t=$data[Task]'>Edit</a></td>
						
						<td><a href='delete.php?i=$data[id]'>Delete</a></td>
						<td>  <a href='know.php?i=$data[id]&n=$data[Name]&m=$data[mob]&e=$data[Mail]&p=$data[Performance]&t=$data[Task]'>Know More</a>                                               </td>
					</tr>";
